...
| <a name="input_lambda_runtime"></a> [lambda\_runtime](#input\_lambda\_runtime) | The lambda runtime to use. One of: `["python3.13", "python3.9", "python3.8", "python3.7"]` | `string` | `"python3.13"` | no |
