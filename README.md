...
| <a name="input_encryption_key_id"></a> [encryption\_key\_id](#input\_encryption\_key\_id) | (optional) The alias, alias ARN, key ID, or key ARN of the KMS key used to encrypt all resources. If not specified, the default AWS KMS key is used. | `string` | `null` | no |
